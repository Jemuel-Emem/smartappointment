            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($staffList as $staff)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $staff->address }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $staff->phone_number }}</td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $staff->service_type }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $staff->speciality }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No staff found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
